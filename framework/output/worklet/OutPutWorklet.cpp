    ...
    struct ComputeLJEnergyVerletWorklet : vtkm::worklet::WorkletMapField
{
                            ...
                            Real& LJPE) const
  {
    ...
    auto function = [&](const Vec3f& p_i, const Vec3f& p_j, const Id& pts_id_j)
    {
      ...
      LJ_PE += force_function.ComputePotentialEn0(r_ij, eps_i, eps_j, sigma_i, sigma_j, _cut_off);
    };
  ...
  Vec3f _box;
    ...
    struct ComputeLJCoulVerletWorklet : vtkm::worklet::WorkletMapField
{
  ComputeLJCoulVerletWorklet(const Real& cut_off, const Real& alpha, const Vec3f& box)
    : _cut_off(cut_off)
    , _alpha(alpha)
    , _box(box)
                            ...
                            Real& LJCoul) const
  {
    ...
    auto function = [&](const Vec3f& p_i, const Vec3f& p_j, const Id& pts_id_j)
    {
      ...
      LJ_coul += force_function.ComputeNearEleEnergy(r_ij, charge_pi, charge_pj, _cut_off, _alpha);
  ...
  Real _alpha;
    ...
    struct ComputeLJEnergyVerletWorklet0 : vtkm::worklet::WorkletMapField
    {
  ComputeLJEnergyVerletWorklet0(const Real& cut_off, const Real& alpha,const Vec3f& box)
    : _cut_off(cut_off)
    , _alpha(alpha)
    , _box(box)
                            ...
                            Real& LJCoul) const
  {
    ...
    auto function = [&](const Vec3f& p_i, const Vec3f& p_j, const Id& pts_id_j)
    {
      ...
      LJ_coul +=
        force_function.ComputeNearEleEnergy(r_ij, charge_pi, charge_pj, _cut_off,_alpha);
  ...
  Vec3f _box;
    ...
    struct ComputeSpecialBondsLJPotentialWorkletN : vtkm::worklet::WorkletMapField
    {
      ComputeSpecialBondsLJPotentialWorkletN(const Real& cut_off, const Vec3f& box)
        : _cut_off(cut_off)
        , _box(box)
      {
      }
      ...
      template<typename idsType,
               ...
               typename NeighbourGroupVecType,
                                ...
                                Real& PotentialEnergy) const
      {
        ...
        auto function = [&](const Vec3f& p_i, const Vec3f& p_j, const Id& pts_id_j)
        {
          ...
          auto pe = force_function.ComputePotentialEn(r_ij, eps_ij, sigma_ij, _cut_off);
    ...
    struct ComputeNearElePotentialWorkletN : vtkm::worklet::WorkletMapField
    {
      ComputeNearElePotentialWorkletN(const Real& cut_off, const Real& nearalpha, const Vec3f& box)
        : _cut_off(cut_off)
        , _nearalpha(nearalpha)
        , _box(box)
      {
                                ...
                                Real& PotentialNearEleEnergy) const
      {
        ...
        auto function = [&](const Vec3f& p_i, const Vec3f& p_j, const Id& pts_id_j)
        {
          ...
          PE_ij +=
            force_function.ComputeNearEleEnergy(r_ij, charge_i, charge_j, _cut_off, _nearalpha);
        };
    ...
    {
      vtkm::cont::Invoker{}(ComputeLJCoulVerletWorklet{ cut_off, alpha, box },
                            atoms_id,
                            locator,
                            topology,
                            force_function,
    ...
    void LJEnergyVerlet0(const Real& cut_off,
                        ...
                        vtkm::cont::ArrayHandle<Real>& LJCoul)
    {
      vtkm::cont::Invoker{}(ComputeLJEnergyVerletWorklet0{ cut_off, alpha,box },
                            atoms_id,
                            locator,
                            topology,
                            force_function,
                                        ...
                                        vtkm::cont::ArrayHandle<Real>& potential_energy)
    {
     ...
     void ComputeSpecialBondsLJPotentialN(const Real& cutoff,
                                        ...
                                        vtkm::cont::ArrayHandle<Real>& potential_energy)
    {
      vtkm::cont::Invoker{}(ComputeSpecialBondsLJPotentialWorkletN{ cutoff, box },
                            atoms_id,
                            locator,
                            topology,
                            force_function,
                                 ...
                                 vtkm::cont::ArrayHandle<Real>& near_potential_energy)
    {
     ...
     void ComputeNearElePotentialN(const Real& cutoff,
                                 ...
                                 vtkm::cont::ArrayHandle<Real>& near_potential_energy)
    {
      vtkm::cont::Invoker{}(ComputeNearElePotentialWorkletN{ cutoff, alpha, box },
                            atoms_id,
                            locator,
                            topology,
                            force_function,
