...
namespace OutPut
{
    ...
    struct ComputePotentialEnPBCWorklet : vtkm::worklet::WorkletMapField
    {
      ComputePotentialEnPBCWorklet(const Real& cut_off, const Vec3f& Vlength)
        : _cut_off(cut_off)
        , _Vlength(Vlength)
      {
      }
                                ...
                                vtkm::cont::ArrayHandle<Real>& potential_energy)
    {
     ...
     void ComputePotentialEnergyPBC(const Real& cutoff,
                                ...
                                vtkm::cont::ArrayHandle<Real>& potential_energy)
    {
      vtkm::cont::Invoker{}(ComputePotentialEnPBCWorklet{ cutoff,Vlength },
                            atoms_id,
                            locator,
                            topology,
                            force_function,
