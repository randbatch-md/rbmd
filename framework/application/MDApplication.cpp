...
void MDApplication::HyperParametersCommandom()
{
  ...
  for (const auto& parameter : parameters)
  {
    ...
    else std::cout << "hyper_parameters is wrong" << std::endl;
  }
}
...
void MDApplication::ExecutionCommandom()
{
 ...
 //   cfg.Add<Application*>("app", this); // 这个app 可以注释掉？！！！
...
void MDApplication::ExecuteCommandom() 
{
