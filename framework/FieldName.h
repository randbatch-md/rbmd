...
namespace field
{
	...
	const std::string bond_coeffs_k3 = "bond_coeffs_k3";
    const std::string bond_coeffs_k4 = "bond_coeffs_k4";
    ...
    const std::string angle_coeffs_k3 = "angle_coeffs_k3";
    const std::string angle_coeffs_k4 = "angle_coeffs_k4";
    const std::string angle_coeffs_equilibrium = "angle_coeffs_equilibrium";
    const std::string bb_m = "bb_m";
    const std::string bb_r1 = "bb_r1";
    const std::string bb_r2 = "bb_r2";
    const std::string ba_n1 = "ba_n1";
    const std::string ba_n2 = "ba_n2";
    const std::string ba_r1 = "ba_r1";
    const std::string ba_r2 = "ba_r2";
