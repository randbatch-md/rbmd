...
namespace RunWorklet
{
    ...
    struct ComputeClass2LJForceWithPeriodicBCWorklet : vtkm::worklet::WorkletMapField
    {
      ComputeClass2LJForceWithPeriodicBCWorklet(const Real& cut_off)
        : _cut_off(cut_off)
      {
      }
                                ...
                                Vec3f& LJforce) const
      {
        ...
        auto function = [&](const Vec3f& p_i, const Vec3f& p_j, const Id& pts_id_j)
        {
          ...
          LJforce +=
            force_function.ComputeClass2LJForce(r_ij, eps_i, eps_j, sigma_i, sigma_j, _cut_off);
        };
        locator.ExecuteOnNeighbor(atoms_id, function);
      }
      Real _cut_off;
   ...
   struct ComputeEAMfp_Worklet : vtkm::worklet::WorkletMapField
                   ...
                   vtkm::cont::ArrayHandle<Vec3f>& eam_force)
    {
     ...
     void NearForceRBLERFSpecialBonds(const Id& rs_num,
                          ...
                          vtkm::cont::ArrayHandle<Vec3f>& corr_force)
     {
       vtkm::cont::Invoker{}(ComputeNearForceRBLERFSpecialBondsWorklet{ rs_num, pice_num, qqr2e },
                             atoms_id,
                             locator,
                             topology,
                             force_function,
    ...
    void Class2LJForceWithPeriodicBC(const Real& cut_off,
                                     ...
                                     vtkm::cont::ArrayHandle<Vec3f>& LJforce)
    {
      vtkm::cont::Invoker{}(ComputeClass2LJForceWithPeriodicBCWorklet{ cut_off },
                            atoms_id,
                            locator,
                            topology,
                            force_function,
